...
public class ControlloParametriDTO {
	...
	/**
	 * check if the counselor selected is in the reserve of counselor and return it
	 * @param consigliere
	 * @param consiglieri
	 * @return the counselor selected if it is present in the reserve, or null in the other case
	 */
	...
	/**
	 * check if the card passed is present in the player hand and return the cartaPoliticaDTO associate
	 * @param carta
	 * @param cartePolitica
	...
	/**
	 * check if tesseraPermesso passed is present in the list of tesserePermesso and return it
	 * @param tessera
	...
	/**
	 * check if the city selected is in the set of city, and if it doesn't contains an emporium
	 * of the colore passed as argument
	 * @param cittàScelta
	 * @param città
	 * @param colore
	 * @return the cittàDTO, or null if it doesn't exist or if it contains an emporium of the colore passed as
	 * argument
	 */
	...
	/**
	 * check if the city selected is in the set of city, and if it contains an emporium
	 * of the colore passed as argument
	 * @param cittàScelta
	 * @param città
	 * @param colore
	 * @return the cittàDTO, or null if it doesn't exist or if it doesn't contains an emporium of the colore passed
	 * as argument
	 */
